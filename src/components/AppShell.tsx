...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-ink text-text">
      ...
      <main className="relative z-10 mx-auto flex min-h-screen w-full max-w-[480px] flex-col px-4 pb-28 pt-safe-top sm:px-5 md:max-w-[760px] lg:ml-72 lg:w-auto lg:max-w-none lg:px-8 lg:pb-10 xl:px-10">
        <div className="flex-1 py-5 lg:mx-auto lg:w-full lg:max-w-[1320px] lg:py-8">{children}</div>
      </main>
